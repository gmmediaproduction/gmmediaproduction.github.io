...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="box-content">
        <?php the_content(); ?>
        <?php if(get_theme_mod('golf_course_remove_tags',true) != ''){ ?>
            <?php the_tags(); ?>
        <?php }?>
        <?php
        ...
        if ( is_singular( 'attachment' ) ) {
            ...
            the_post_navigation( array(
                'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'golf-course' ),
            ) );
        } elseif ( is_singular( 'post' ) ) {
            // Previous/next post navigation.
            the_post_navigation( array(
                'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next:', 'golf-course' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
                'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous:', 'golf-course' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
            ) );
        }
    ?>
